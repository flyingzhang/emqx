...
echo ""
echo "运行镜像示例（启用持久化会话）："
echo "docker run -d --name emqx -p 1883:1883 -p 8083:8083 -p 8084:8084 -p 8883:8883 -p 18083:18083 \\"
echo "  -e EMQX_DURABLE_SESSIONS__ENABLE=true \\"
echo "  -e EMQX_DURABLE_STORAGE__MESSAGES__BACKEND=builtin_local \\"
echo "  -e EMQX_CLUSTER__DISCOVERY_STRATEGY=singleton \\"
echo "  \$(head -1 .emqx_docker_image_tags)"
